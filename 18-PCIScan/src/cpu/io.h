...
// Read a 32-bit value of type long from an I/O port. PCI config space is in 4 byte chunks, so we need this instead of inb. l means long, 32 bits.
...
// Also need a write 32 bit long to an I/O port.
